...
export default async function HomeProducts() {
  return (
    <>
      ...
      <section className="py-16 bg-linear-to-b from-white to-gray-50 font-medium"  >
